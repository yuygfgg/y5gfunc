...
def tonemap(
    ...
    return core.placebo.Tonemap(
        ...
        src_csp=src_csp_int,
        dst_csp=dst_csp_int,
        dst_prim=dst_prim_int,  # type: ignore[arg-type]
        src_max=src_max,  # type: ignore[arg-type]
        src_min=src_min,  # type: ignore[arg-type]
        dst_max=dst_max,  # type: ignore[arg-type]
        dst_min=dst_min,  # type: ignore[arg-type]
        ...
        tone_mapping_param=tone_mapping_param,  # type: ignore[arg-type]
        metadata=metadata_int,
        use_dovi=use_dovi,  # type: ignore[arg-type]
