    ...
    def process(
        ...
        with safe_processing("resize_and_depth_processing"):
            ...
            if resize_filter_name:
                resize_filter_name = (
                    resize_filter_name[0].upper() + resize_filter_name[1:]
                )
            else:
            ...
            if depth_enabled:
                ...
                sample_type = (
                    VideoFormat.FLOAT if float_samples else VideoFormat.INTEGER
                )

                format_id = query_format(clip, bits, sample_type)
